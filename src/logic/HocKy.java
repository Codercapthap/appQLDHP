...
public class HocKy {
    public static String[] getDSHocKy() {
        String[] dsHK = null;
        try {
            ...
            String sql = "SELECT ds_hoc_ky FROM hoc_ky;";
            ...
            if(rs.getType() == ResultSet.TYPE_FORWARD_ONLY) {	// Nếu ResultSet chỉ có thể duyệt 1 chiều từ trên xuống
                ...
                dsHK = new String[count];		// Cấp phát mảng có số lượng phần tử là count
                ...
                while(rs.next()) {
                    dsHK[count] = new String(rs.getString("ds_hoc_ky"));
                    count++;
                }
                ...
                dsHK = new String[rs.getRow()];	// Cấp phát mảng có số lượng phần tử là số thứ tự của hàng hiện tại
                ...
                while(rs.next()) {
                    dsHK[i] = new String(rs.getString("ds_hoc_ky"));
                    i++;
                }
            }
